...
function prfSampleModel_curv_computeCanada(isub,visualRegion)
...
curvfolder = '/home/hanseohe/scratch/stimuli/curvfilter/';%to save model outputs
...
for roinum=1:length(rois)
    ...
    prffolder = '/home/hanseohe/projects/def-waltherd/hanseohe/nsddata/prfsample_curv/';
