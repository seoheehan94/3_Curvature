...
save_R2folder = '/home/hanseohe/Documents/GitHub/3_Curvature/NSD_curvature_filter/R2_analysis/';
...
writematrix(curRoiR2CurvSplit', ...
    fullfile(save_R2folder, ['allroiR2_filter','.csv']));
...
for r = 1:numel(combinedRoiNames)
    ...
    writematrix(dataVar', ...
        fullfile(save_R2folder, [roiName 'R2_filter', '.csv']));
end
